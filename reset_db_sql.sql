-- reset_db.sql - Script para limpiar completamente la base de datos corrupta
-- Ejecutar cuando tengas problemas con tablas corruptas
...
-- DATOS BÁSICOS ESENCIALES (SOLO LO MÍNIMO)

-- Insertar tipos de servicios básicos
...
('dias_aviso', '5', 'Días antes del vencimiento para enviar aviso'),
...
-- Triggers para fechas de modificación
DELIMITER //
...
SELECT '✅ BASE DE DATOS LIMPIA CREADA CORRECTAMENTE' as estado;
SELECT '📋 Lista para producción - Sin datos de ejemplo' as mensaje;
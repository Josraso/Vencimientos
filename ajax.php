...
case 'reset_database':
    // Debug mejorado
    file_put_contents('reset_debug.log', "POST data: " . print_r($_POST, true) . "\n", FILE_APPEND);
...
$notificaciones = isset($_POST['notificaciones']) && ($_POST['notificaciones'] === 'true' || $_POST['notificaciones'] === true);
    ...
    file_put_contents('reset_debug.log', "Flags: clientes=$clientes, servicios=$servicios, servicios_cliente=$servicios_cliente, albaranes=$albaranes, notificaciones=$notificaciones\n", FILE_APPEND);
    ...
    try {
        ...
        file_put_contents('reset_debug.log', "Resultado: $mensaje\n", FILE_APPEND);
        
        $response['success'] = true;
        $response['message'] = $mensaje;
        
    } catch (Exception $e) {
        file_put_contents('reset_debug.log', "Error: " . $e->getMessage() . "\n", FILE_APPEND);
